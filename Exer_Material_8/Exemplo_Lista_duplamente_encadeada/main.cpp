...
//Função para criar um novo nó com o dado fornecico
...
void inserirNoInicio(Node** cabeca, int dado)
{
    ...
    //Atualiza os ponteiros do noco nó e do nó atual no inicio da lista
    ...
    //Atualiza o ponteiro para o novo nó como nó no inicio da lista
    *cabeca = novoNo;
    }
    ...
    void removerNo(Node** cabeca, int dado)
    {
        ...
        //Se o nó foi encontrado, remove-se da lista
        if(atual != nullptr)
        {
